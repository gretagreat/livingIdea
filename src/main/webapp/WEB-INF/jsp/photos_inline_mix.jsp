           ...
           <div class="carousel slide multi-item-carousel" id="theCarousel">
               <div class="carousel-inner">
                   <div class="item active">
                        <div class="col-xs-4"><a href="#1"><img src="${pageContext.request.contextPath}/images/room.jpg" class="img-responsive"></a></div> 
                        <h1 class="col-xs-4 text-center text-muted">Classic</h1> 
                   </div>
                   <div class="item">
                        ...
                        <h1 class="col-xs-4 text-center text-muted">Mid-Century Modern</h1> 
                   </div>
                    <div class="item">
                        <div class="col-xs-4"><a href="#1"><img src="${pageContext.request.contextPath}/images/office.jpg" class="img-responsive"></a></div> 
                        <h1 class="col-xs-4 text-center text-muted">Industrial</h1> 
                   </div>
               </div>
           </div>
